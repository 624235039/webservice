...
$app->group('/api', function () use ($app) {
    ...
    $app->post('/condo', function ($request, $response) {
        ...
        //--- insert data to db
        $sql = "INSERT INTO condo (condo_id,condo_name,condo_price,condo_location,condo_phone,condo_detail,condo_image) VALUES (:condo_id,:condo_name,:condo_price,:condo_location,:condo_phone,:condo_detail,:condo_image)";
        $sth = $this->db->prepare($sql);
        $sth->bindParam("cond_id", $input['condo_id']);
